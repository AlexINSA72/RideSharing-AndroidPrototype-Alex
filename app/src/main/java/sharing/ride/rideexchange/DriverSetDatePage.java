...
public class DriverSetDatePage extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_driver_set_date);
    ...
    {
        Intent intent = new Intent(this, DriverSetTimePage.class);
